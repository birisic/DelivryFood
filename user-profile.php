...
<body>
   ...
   ?>
    <div class="header-main" id="home">
                    ...
                    <div class="three-img">
                       <div class="container">
                          <div class="slider-info mb-header-spacing">
                             <h5 id="mb-restaurant-title">Welcome, <?=$userFirstName?>!</h5>
      ...
      <div class="container">
        <div class="row">
            <div class="col-lg-5 col-md-6 col-11 mx-auto d-flex justify-content-center">
                <div class="mb-logout mb-5">
                    <a href="logic/logout.php" class="btn btn-warning text-white fs-5">Logout</a>
                </div>
            </div>
        </div>
      </div>
